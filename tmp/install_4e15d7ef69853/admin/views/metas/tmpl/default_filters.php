 ...
 * @version     $Id: default_filters.php 1624 2010-09-12 15:45:08Z silianacom-svn $
 */
...
<table>
  <tr>
    <td align="left" nowrap="nowrap">
      ...
      <input type="text" name="search_all" id="search_all" value="<?php echo $this->options->search_all;?>" size="35" maxlength="255" class="text_area" onchange="document.adminForm.limitstart.value=0;shMetasClearFields();document.adminForm.submit();" />
