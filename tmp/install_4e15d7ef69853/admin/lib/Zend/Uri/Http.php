 ...
 * @version   $Id: Http.php 1611 2010-09-08 14:28:08Z silianacom-svn $
 */
...
/*
 * Shumisha : simplify
 * require_once JPATH_COMPONENT . DS . 'lib' . DS . 'Zend/Validate/Hostname.php';*/
...
class Sh_Zend_Uri_Http extends Sh_Zend_Uri
{
    ...
    protected function __construct($scheme, $schemeSpecific = '')
    {
        ...
        // Validate the URI
        if ($this->valid() === false) {
            require_once JPATH_COMPONENT . DS . 'lib' . DS . 'Zend/Uri/Exception.php';
