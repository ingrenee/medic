 ...
 * @version     $Id: com_community.php 1614 2010-09-09 07:31:37Z silianacom-svn $
 *
 */
...
switch($view){
  ...
  case 'events':
    ...
    if (empty($task) || $task=='uploadavatar' || $task=='myinvites' || $task == 'expiredevents' || $task== 'search') {
...
switch($task){
  ...
  case 'create':
    switch ($view) {
      case 'groups':
        $title[] = JText::_('CC CREATE NEW GROUP TITLE');
        break;
      case 'events':
        $title[] = JText::_('CC CREATE NEW EVENT');
        break;
      default:
        $title[] = $task;
        break;
  ...
  case 'uploadavatar':
    switch ($view) {
      ...
      case 'profile':
        ...
        break;
      case 'events':
        $title[] = JText::_('CC EDIT EVENT AVATAR');
        break;
      default:
        $title[] = $task;
        break;
  ...
  case 'edit':
    switch ($view) {
      ...
      case 'profile':
        ...
        break;
      case 'events':
        $title[] = JText::_('CC EDIT EVENT DETAILS');
        break;
      default:
        $title[] = $task;
        break;
  ...
  case 'privacy':
    ...
    // photos
  case 'myphotos':
    $title[] = JText::_('CC MY PHOTOS TITLE');
    $title[] = '/';
    break;
  case 'newalbum':
