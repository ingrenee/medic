 ...
 * @subpackage Client
 * @version    $Id: Client.php 1611 2010-09-08 14:28:08Z silianacom-svn $
 ...
 * @see Sh_Zend_Uri
 */
require_once JPATH_COMPONENT . DS . 'lib' . DS . 'Zend/Uri.php';


/**
 * @see Sh_Zend_Http_Client_Adapter_Interface
 */
require_once JPATH_COMPONENT . DS . 'lib' . DS . 'Zend/Http/Client/Adapter/Interface.php';


/**
 * @see Sh_Zend_Http_Response
 */
require_once JPATH_COMPONENT . DS . 'lib' . DS . 'Zend/Http/Response.php';

/**
 * @see Sh_Zend_Http_Response_Stream
 */
require_once JPATH_COMPONENT . DS . 'lib' . DS . 'Zend/Http/Response/Stream.php';
...
class Sh_Zend_Http_Client
{
    ...
    public function setCookieJar($cookiejar = true)
    {
        if (! class_exists('Sh_Zend_Http_CookieJar')) {
            require_once JPATH_COMPONENT . DS . 'lib' . DS . 'Zend/Http/CookieJar.php';
        }
    ...
    public function setCookie($cookie, $value = null)
    {
        if (! class_exists('Sh_Zend_Http_Cookie')) {
            require_once JPATH_COMPONENT . DS . 'lib' . DS . 'Zend/Http/Cookie.php';
        }
