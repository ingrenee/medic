 ...
 * @version     $Id: analyticsgareportdashboard.php 1564 2010-08-23 18:18:13Z silianacom-svn $
 */
...
class Sh404sefAdapterAnalyticsgareportdashboard {
  ...
  public function __construct() {
    ...
    $this->_baseChartPath = JPATH_COMPONENT . DS . 'lib' . DS . 'pChart';
  ...
  protected function _createVisitsGraph() {
    ...
    // le nom du fichier est maintenant variable pour eviter une mise en cache par le navigateur
    $basePath = 'tmp' . DS . 'sh404sef_analytics' . DS . $user->id . DS;
  ...
  protected function _createSourcesGraph() {
    ...
    $data = array();
    $types = array();
    foreach( $this->_rawData['sources'] as $entry) {
      $data[] = $entry->$dataTypeString;
