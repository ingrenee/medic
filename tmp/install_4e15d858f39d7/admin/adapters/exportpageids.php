 ...
 * @version     $Id: exportpageids.php 1414 2010-05-23 21:04:41Z silianacom-svn $
 */
...
class Sh404sefAdapterExportpageids extends JObject {
  ...
  public function doExport() {
    ...
    $options = (object) array('layout' => 'default', 'getPageId' => true);
  ...
  protected function _export( $start) {
    ...
    if (!empty( $records)) {
      foreach( $records as $record) {
        $counter++;
        $textRecord = $record->pageid . $glue . $record->oldurl . $glue  . $record->newurl
