 ...
 * @version     $Id: analytics.php 1591 2010-08-31 18:35:00Z silianacom-svn $
 */
...
class Sh404sefHelperAnalytics {
  ...
  public static function getReferralLabel( $rawReferralType) {
    ...
    switch ($rawReferralType) {
      ...
      case 'referral':
        ...
        break;
      default:
        $label = JText16::_('COM_SH404SEF_ANALYTICS_REF_LABEL_OTHER');
        break;
    }
  ...
  public static function createTempFile( $basePath, $report) {
    ...
    // check dir exists
    JFolder::create( JPATH_ROOT . DS . $basePath);
